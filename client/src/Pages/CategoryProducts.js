...
function CategoryProducts() {
  const [cateProductsList, setCateProductsList] = useState([]);
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/api/productlist/${categoryNumber}`, {
       
      })
      .then((response) => {
        setCateProductsList(response.data);
